...
sealed interface WorkshopStage {
    ...
    @Serializable enum class CoroutinePuzzleStage(override val kotlinFile: String): WorkshopStage {
        ...
        ShipmentTrackingIndependentViews("ShipmentTracking.kt"),
        ShipmentTrackingSharedConnection("ShipmentTracking.kt"),
        ShipmentTrackingLateEtaCard("ShipmentTracking.kt"),
        ShipmentTrackingLazyConnection("ShipmentTracking.kt"),
        ShipmentTrackingWhileSubscribed("ShipmentTracking.kt"),
        ChatMessagesRendezvous("ChatChannels.kt"),
        ChatMessagesBuffered("ChatChannels.kt"),
        ChatTypingStatusDropOldest("ChatChannels.kt"),
